  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-luxury-black p-4">
      ...
      <div className="text-center mb-10 z-10">
        ...
        <p className="text-luxury-cream/60">Scent of Luxury Management Platform</p>
      </div>
      
      <LuxuryCard className="w-full max-w-md glass-card z-10 p-8">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-display gold-gradient-text">Welcome Back</h2>
          <p className="text-luxury-cream/60 text-sm mt-1">Sign in to your account</p>
        </div>
        
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="email" className="block text-sm text-luxury-cream/80 mb-2">
              Email
            </label>
            <input
              id="email"
              ...
              className="w-full bg-black/30 border border-luxury-gold/20 rounded-md py-2 px-3 text-luxury-cream focus:outline-none focus:border-luxury-gold"
              value={email}
          ...
          <div>
            <label htmlFor="password" className="block text-sm text-luxury-cream/80 mb-2">
              Password
            </label>
            <input
              id="password"
        ...
        <div className="mt-6 flex items-center justify-center">
          <div className="flex-1 h-[1px] bg-luxury-gold/20"></div>
          <span className="px-4 text-xs text-luxury-cream/60">Or</span>
          <div className="flex-1 h-[1px] bg-luxury-gold/20"></div>
        </div>
        
        <div className="mt-6 flex flex-col items-center">
          <p className="text-sm text-luxury-cream/80 mb-3">Sign in with voice recognition</p>
          ...
          <p className="mt-3 text-xs text-luxury-cream/60">
