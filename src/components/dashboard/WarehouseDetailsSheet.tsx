          ...
          <div className="space-y-6">
            ...
            <LuxuryCard className="p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-luxury-cream/60">Total Items:</span>
                ...
                {warehouse.low_stock_count !== undefined && (
                  <div className="flex justify-between">
                    <span className="text-luxury-cream/60">Low Stock Items:</span>
            ...
            {warehouse.categories && warehouse.categories.length > 0 && (
              <LuxuryCard className="p-4">
                <h3 className="text-lg font-display text-luxury-gold mb-4">Product Categories</h3>
            ...
            <LuxuryCard className="p-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-luxury-black/30 rounded-lg">
                  ...
                  <div className="text-sm text-luxury-cream/60">Stock Health</div>
                </div>
                <div className="text-center p-3 bg-luxury-black/30 rounded-lg">
                  <div className="text-xl font-bold text-luxury-gold">
                    {warehouse.inventory_value ? Math.round(warehouse.inventory_value / warehouse.total_items) : 'N/A'}
                  </div>
                  <div className="text-sm text-luxury-cream/60">Avg. Item Value</div>
                </div>
              </div>
            </LuxuryCard>
          </div>
